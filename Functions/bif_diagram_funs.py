...
def get_bif_input(param_key, param_vec, params_base, num_init = 10, 
    ...
    rows_prey1_extinct = get_prey_extinct_equilibria(param_key, param_vec, i=1, 
                          num_init = num_init,
                          num_perturbations = num_perturbations,
                          perturb_strength = perturb_strength, 
                          **params_base) 
    rows_prey2_extinct = get_prey_extinct_equilibria(param_key, param_vec, 
                              i=2, num_init = num_init,
                              num_perturbations = num_perturbations,
                              perturb_strength = perturb_strength, 
                              **params_base) 
...
def plot_bif_legend():
    ...
    legend_handles = [
        ...
        Line2D([0], [0],  **unstable_markers, markeredgecolor='black', 
               label='Unstable, Coexist'),
        Line2D([0], [0], **unstable_markers, markeredgecolor='blue', 
               label='Unstable, Predator Extinct'),
        Line2D([0], [0], **unstable_markers, markeredgecolor='red', 
               label='Unstable, Prey 1 Extinct'),
        Line2D([0], [0], **unstable_markers, markeredgecolor='cyan', 
               label='Unstable, Prey 2 Extinct'),
    ]
    axlegend.axis('off') 
