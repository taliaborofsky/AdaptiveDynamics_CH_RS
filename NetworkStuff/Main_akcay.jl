...
type NetworkParam
    ...
    b::Float64             # total benefit provided by cooperators
    c::Float64             # total cost incurred by cooperators
    d::Float64             # synergistic benefit from cooperation
    mu::Float64            # mutation rate for cooperator locus
    evollink::Bool
    mulink::Float64
    sigmapn::Float64
    sigmapr::Float64
    clink::Float64
    retint::Int64
    funnoevollink::String # which game to use, links do not evolve
    funevollink::String # which game to use, links do evolve
    delta::Float64
    payfun::String
    replicates::Int64
...
function main()
  ...
  if params.funnoevollink == "PD"
      funnoevollinkin = networkitPD # this is the name of a function
